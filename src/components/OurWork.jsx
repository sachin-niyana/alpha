    ...
    return (
        <div>
            <div className='container max-w-[1152px] mx-auto px-3'>
                <div className="sm:border-r-[1px] lg:mr-[38.1px] lg:items-start border-[#2B2B2B]">
                            ...
                            <div className='flex flex-wrap mt-10 sm:mt-[67px] justify-center items-center'>
                                ...
                                <div className='sm:w-[50%] md:w-[57%] flex sm:justify-center sm:items-center xl:justify-start xl:items-start'>
                                    <div className='border-[#2b2b2b] border-[1px] sm:border-t-[1px] px-[14px] pt-[41px]  max-w-[284px]  md:max-w-[284.12px] pb-[51px] relative'>
                                        <h4 className='text-[40px] font-normal text-rich-black font-inter absolute bg-[#ECEAE7] top-[-15%] left-[10%]'>02</h4>
                                        <h3 className='font-semibold font-inter text-rich-black text-md mb-[13px] capitalize'>ENGIE Impact</h3>
                                        <p className='text-sm font-normal font-inter text-[#656463] capitalize'>Speak to ideal clients that are outside your network. Discover new markets and grow your </p>
                                    </div>
                                </div>
                                <div className='sm:w-[50%] md:w-[43%] flex justify-end items-end'>
                                    <div className='border-[#2b2b2b] border-[1px]  border-t-[0px] xl:border-r-[0px] lg:border-t-[0px] px-[14px] pt-[41px] max-w-[284px]   md:max-w-[284.12px] pb-[51px] relative'>
                                        <h4 className='text-[40px] font-normal text-rich-black font-inter absolute bg-[#ECEAE7] top-[-15%] left-[10%]'>03</h4>
                                        <h3 className='font-semibold font-inter text-rich-black text-md mb-[13px] capitalize'>GridBeyond</h3>
                                        <p className='text-sm font-normal font-inter text-[#656463] capitalize'>Speak to ideal clients that are outside your network. Discover new markets and grow your </p>
                                    </div>
                                </div>
                                <div className='sm:w-[50%] md:w-[57%] flex sm:justify-center sm:items-center xl:justify-start xl:items-start'>
                                    <div className='border-[#2b2b2b] border-[1px]  border-t-[0px] lg:border-t-[0px] px-[14px] pt-[41px] max-w-[284px]   md:max-w-[284.12px] pb-[51px] relative'>
                                        <h4 className='text-[40px] font-normal text-rich-black font-inter absolute bg-[#ECEAE7] top-[-15%] left-[10%]'>04</h4>
                                        <h3 className='font-semibold font-inter text-rich-black text-md mb-[13px] capitalize'>eEnergy Management</h3>
                                        <p className='text-sm font-normal font-inter text-[#656463] capitalize'>Speak to ideal clients that are outside your network. Discover new markets and grow your </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='lg:w-[30%] xl:w-[40%]'>  <Image
                            src="/assets/images/our-works/graph.png"
                            width={459.45}
                            height={550.02}
                            alt="graph" className='mt-10 md:mt-20 lg:mt-[150px] xl:mt-20 mb-20 lg:mb-[133px]' />
                        </div>
                    </div>
                </div>
            </div>
