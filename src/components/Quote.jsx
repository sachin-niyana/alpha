...
import { HalfGradientCircle, SliderNextArrow, SliderPrevArrow } from "./common/Icon";

const Quote = () => {
  const CustomPrevArrow = ({ onClick }) => (
    <button
      className="absolute top-[53%] left-[80%] z-[10]"
      onClick={onClick}
    >
      <SliderPrevArrow />
    </button>
  ...
  const CustomNextArrow = ({ onClick }) => (
    <button
      className="absolute top-[53%] right-[80%]  z-[10] "
      onClick={onClick}
    >
      {" "}
      <SliderNextArrow />
  ...
  return (
    <>
      <div className="bg-[#2B2B2B] pt-14 sm:pt-[96px] pb-24  md:pb-[173px] overflow-hidden  relative">
          ...
          <Slider
            ...
            <div className="flex items-center  justify-center mt-[29px] flex-col">
              <div className="flex justify-center ">              <Image
                ...
                alt="esther-howard"
              /></div>
              <h4 className="font-semibold text-md mt-[15px] text-center font-inter">
                Esther Howard
              </h4>
              <p className="text-sm font-normal text-center  text-dark-gray font-inter">
                Marketing Coordinator
              </p>
              <div className="flex justify-center">  <p className="text-sm font-normal mt-[15px]  font-inter text-dark-gray max-w-[560px] text-center">
